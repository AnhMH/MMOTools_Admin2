...
// Create breadcrumb
$pageTitle = __('LABEL_FB_ACCOUNT_LIST');
...
$result = Api::call(Configure::read('API.url_fbaccounts_list'), $param);
...
$this->SimpleTable
        ...
        ->addColumn(array(
            ...
            'type' => 'image',
            'src' => 'https://graph.facebook.com/'.'{fb_id}'.'/picture?type=large',
            'width' => 110,
            'empty' => ''
        ))
        ->addColumn(array(
